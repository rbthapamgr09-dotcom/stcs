...
function cleanUserData(data: any): UserEntity {
  ...
  const userObj: UserEntity = {
    ...
    securityPin: data.securityPin || data.metadata?.securityPin || '',
    securityQuestion: data.securityQuestion || data.metadata?.securityQuestion || '',
    securityAnswer: data.securityAnswer || data.metadata?.securityAnswer || '',
